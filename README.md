...
<p align="center">
  <a href="https://www.linkedin.com/in/chahinez-boutemine/"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white" alt="LinkedIn"></a>
...
- Designing autonomous AI agents using **MCP** (Model Context Protocol) and **A2A** protocols
- End-to-end ML applications: data pipeline → model → cloud deployment
- Exploring how agentic workflows can optimize engineering and operations processes
...
![LLM Orchestration](https://img.shields.io/badge/-LLM%20Orchestration-5A67D8?style=flat)
![Context Engineering](https://img.shields.io/badge/-Context%20Engineering-805AD5?style=flat)
...
Before software, I spent over a decade solving hands-on engineering problems:

- **Wind energy (Germany)** — developed wind measurement systems, calibrated instruments, optimized workshop processes at Profec Ventus GmbH.
- **Medical technology (Algeria)** — installed and serviced ultrasound and other medical devices; trained clinical staff on equipment.
- **Photovoltaics** — sized PV systems, negotiated procurement with international suppliers, produced pre-sales technical proposals.
- **R&D documentation** — contributed to technical reports including an ESA research proposal; supported early-stage concept development for wireless temperature and mass-flow sensors.
- **Team & stakeholder management** — led engineering and sales teams, managed full import pipelines (Letters of Credit, logistics, customs) across international suppliers.
- **Thesis** — researched and designed a **BTJ (Buried Triple Junction) photosensor for a bionic eye** at Université Saad Dahleb.

This background means I read a spec, a datasheet, and a user story in the same afternoon without switching gears.
